...
class ProductoController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        foreach ($productos as $key => $producto) {
            $productos[$key] = $this->getProductoSimple($producto);
        }
    ...
    public function getProductoSimple($producto)
    {
        $productod = [];
        $productod['store_producto_id'] =  $producto->store_producto_id;
        $productod['store_producto_nombre'] = html_entity_decode($producto->store_producto_nombre);
        $productod['store_producto_descripcion'] = $producto->store_producto_descripcion;
        $miniatura = Images::ImageResize($producto->store_producto_imagen,200);
        if($miniatura != ''){
            $productod['miniatura'] = "https://togroow.com".str_replace(" ","%20",$miniatura);;
        }
        $productod['valores'] = $this->getValores($producto);
        return  $productod;
    }
    ...
    public function getProducto($producto)
    {
        ...
        $producto['miniatura'] = "https://togroow.com".Images::ImageResize($producto->store_producto_imagen,200);
        $producto['store_producto_imagen'] = "https://togroow.com".Images::ImageResize($producto->store_producto_imagen,800);
        for ($i = 2; $i < 10; $i++) {
            $imagecolum =  'store_producto_imagen' . $i;
            if ($producto->$imagecolum != '') {
                $producto['store_producto_imagen' . $i] = "https://togroow.com".Images::ImageResize($producto->$imagecolum,800);
            }
        }
    ...
    public function saveProduct(Request $request)
    {
        ...
        if(!isset($data['store_producto_estado']) || $data['store_producto_estado'] == '' || $data['store_producto_estado'] == 0 ){
            $data['store_producto_estado'] = 0;
        }
    ...
    public function insert($request)
    {
        ...
        if(isset($data['store_producto_envio_dimenciones_alto']) && isset($data['store_producto_envio_dimenciones_largo']) && isset($data['store_producto_envio_dimenciones_ancho']) ){
            $alto = $data["store_producto_envio_dimenciones_alto"];
            $largo = $data["store_producto_envio_dimenciones_largo"];
            $ancho = $data["store_producto_envio_dimenciones_ancho"];
            $data['store_producto_envio_dimenciones'] = $alto."x".$largo."x".$ancho;
        }
    ...
    public function getCategoriasNegocio(Request $request ){
        $data = $request->all();
        $negocio = 0;
        if(isset($data['negocio'])){
        ...
        $categorias = [];
        if($negocio == 1384){
            $categorias = $this->getCategoriasBaulito();     
        } else {
            $categorias = Categoriasproductos::where("store_categoria_padre",0)->where("store_categoria_tipo",1)->get();
        }
        return response()->json(["categorias" => $categorias]);
    }

    public function getCategoriasBaulito(){
        $categorias = [];
        $categorias[0] = [];
        $categorias[0]['store_categoria_id'] = 2970;
        $categorias[0]['store_categoria_titulo'] = "Calzado";
        $categorias[1] = [];
        $categorias[1]['store_categoria_id'] = 2975;
        $categorias[1]['store_categoria_titulo'] = "Chaquetas";
        $categorias[2] = [];
        $categorias[2]['store_categoria_id'] = 2977;
        $categorias[2]['store_categoria_titulo'] = "Pantalones";
        $categorias[3] = [];
        $categorias[3]['store_categoria_id'] = 2973;
        $categorias[3]['store_categoria_titulo'] = "Buzos";
        $categorias[4] = [];
        $categorias[4]['store_categoria_id'] = 2985;
        $categorias[4]['store_categoria_titulo'] = "Camisetas";
        $categorias[5] = [];
        $categorias[5]['store_categoria_id'] = 2972;
        $categorias[5]['store_categoria_titulo'] = "Camisas";
        $categorias[6] = [];
        $categorias[6]['store_categoria_id'] = 2978;
        $categorias[6]['store_categoria_titulo'] = "Pantalonetas";
        $categorias[7] = [];
        $categorias[7]['store_categoria_id'] = 4573;
        $categorias[7]['store_categoria_titulo'] = "Accesorios";
        return $categorias;
    }
}
